...
import 'package:flutter_page_navigation/SensorsPage.dart';

class SelectDevicePage extends StatefulWidget {
  const SelectDevicePage({Key? key, required this.title}) : super(key: key);
  ...
  @override
  State<SelectDevicePage> createState() => _SelectDevicePage();
}
